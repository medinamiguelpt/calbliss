...
const footer = `<p style="color:#6B6880;font-size:11px;margin:16px 0 0;">© 2026 ${BRAND_NAME} · <a href="${SITE_URL}" style="color:#7C3AED;">${SITE_URL.replace("https://","")}</a></p>`
const footerUnsubscribe = `<p style="color:#6B6880;font-size:11px;margin:16px 0 0;">© 2026 ${BRAND_NAME} · You're receiving this because you joined our waitlist.</p>`
...
<div style="max-width:520px;margin:40px auto;background:#fff;border-radius:16px;border:1px solid #E4DCFF;overflow:hidden;">
  ...
  <div style="padding:32px 40px;">
    <p style="color:#1A1027;font-size:15px;line-height:1.7;margin:0 0 20px;">
      You joined the ${BRAND_NAME} waitlist — and we haven't forgotten you. While we get your setup ready, here's one thing to think about:
    </p>
  ...
  <div style="border-top:1px solid #E4DCFF;padding:20px 40px;text-align:center;">
    <a href="${SITE_URL}/#get-started" style="display:inline-block;background:#7C3AED;color:#fff;font-weight:700;border-radius:40px;padding:12px 28px;text-decoration:none;font-size:14px;">Get your agent now →</a>
    ${footer}
  </div>
</div></body></html>`,
  },
...
<div style="max-width:520px;margin:40px auto;background:#fff;border-radius:16px;border:1px solid #E4DCFF;overflow:hidden;">
  ...
  <div style="padding:32px 40px;">
    <p style="color:#1A1027;font-size:15px;line-height:1.7;margin:0 0 20px;">
      Carlos M. runs The Barber Studio in Austin. Before ${BRAND_NAME}, he was losing 3–4 bookings every Saturday — missed calls while he was cutting hair.
    </p>
    <div style="border-left:3px solid #7C3AED;padding:12px 20px;margin-bottom:24px;background:#F0EBFF;border-radius:0 8px 8px 0;">
      <p style="color:#1A1027;font-size:14px;line-height:1.6;margin:0;font-style:italic;">
        "${BRAND_NAME} paid for itself in the first week. My Friday and Saturday slots now fill by Wednesday. I haven't missed a call since."
      </p>
  ...
  <div style="border-top:1px solid #E4DCFF;padding:20px 40px;text-align:center;">
    <a href="${SITE_URL}/#get-started" style="display:inline-block;background:#7C3AED;color:#fff;font-weight:700;border-radius:40px;padding:12px 28px;text-decoration:none;font-size:14px;">Start my free trial →</a>
    ${footer}
  </div>
</div></body></html>`,
  },
...
<div style="max-width:520px;margin:40px auto;background:#fff;border-radius:16px;border:1px solid #E4DCFF;overflow:hidden;">
  <div style="background:#0D0714;padding:32px 40px;">
    ...
    <h1 style="color:#fff;font-size:22px;font-weight:800;margin:10px 0 0;line-height:1.3;">Is ${BRAND_NAME} right for you?</h1>
  </div>
  <div style="padding:32px 40px;">
    <p style="color:#1A1027;font-size:15px;line-height:1.7;margin:0 0 20px;">
      It's been a week. You haven't signed up yet — that's totally fine. Here's an honest breakdown of who ${BRAND_NAME} works best for:
    </p>
    ...
    <p style="color:#6B6880;font-size:13px;line-height:1.6;margin:0;">
      Not sure which camp you're in? Reply to this email — we'll tell you honestly whether ${BRAND_NAME} is worth it for your specific business.
    </p>
  </div>
  <div style="border-top:1px solid #E4DCFF;padding:20px 40px;text-align:center;">
    <a href="${SITE_URL}/#get-started" style="display:inline-block;background:#7C3AED;color:#fff;font-weight:700;border-radius:40px;padding:12px 28px;text-decoration:none;font-size:14px;">I'm a good fit — sign me up →</a>
    ${footerUnsubscribe}
  </div>
</div></body></html>`,
  },
